...
- **Functional**: repository scope, direct contract integration, upgrades, policy-chain design, identity credentials, SecureMintPolicy, and token examples
...
- Answers rely on the public `smartcontractkit/chainlink-ace` repo, not public docs pages
